            ...
            <Card className="h-full">
              <div className="p-6 h-full flex flex-col">
                ...
                <div className="mb-4 flex-1">
                  <p className="text-sm font-semibold text-neutral-700 dark:text-neutral-200 mb-2">Key Features:</p>
                ...
                <div className="flex gap-3 pt-4 border-t border-neutral-100 dark:border-neutral-800">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 text-center px-4 py-2 border-2 border-neutral-300 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300 rounded-lg hover:border-neutral-400 dark:hover:border-neutral-600 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-all duration-200 text-sm font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-500"
                  >
                    GitHub
                  </a>
                </div>
