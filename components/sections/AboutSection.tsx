  ...
  return (
    <Section id="about" background="white">
      ...
      <div className="max-w-4xl mx-auto">
        <AnimateOnScroll>
          <div className="bg-gradient-to-br from-primary-50 to-white dark:from-primary-900/20 dark:to-neutral-900 border border-transparent dark:border-primary-800/30 p-8 md:p-12 rounded-2xl shadow-lg dark:shadow-primary-500/10 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {highlights.map((highlight, index) => (
            <AnimateOnScroll key={index} delay={index * 100}>
              <div className="bg-white dark:bg-[#1a1a1a] p-6 rounded-xl shadow-md dark:shadow-primary-500/10 hover:shadow-lg dark:hover:shadow-primary-500/20 transition-shadow duration-300 border border-neutral-100 dark:border-neutral-800">
