  ...
  return (
    <Section id="about" background="white">
      ...
      <div className="max-w-4xl mx-auto">
        <AnimateOnScroll>
          <div className="bg-gradient-to-br from-primary-50 to-white dark:from-primary-900/10 dark:to-[#1a1a1a] p-8 md:p-12 rounded-2xl shadow-lg mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {highlights.map((highlight, index) => (
            <AnimateOnScroll key={index} delay={index * 100}>
              <div className="bg-white dark:bg-[#1a1a1a] p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-neutral-100 dark:border-neutral-800">
