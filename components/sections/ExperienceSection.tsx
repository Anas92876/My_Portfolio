            ...
            {experiences.map((exp, index) => (
              <AnimateOnScroll key={index} delay={index * 100}>
                <div className="relative pl-8 md:pl-12 border-l-2 border-primary-300 dark:border-primary-700">
                  ...
                  <div className="bg-white dark:bg-[#1a1a1a] p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {achievements.map((achievement, index) => (
              <AnimateOnScroll key={index} delay={index * 100}>
                <div className="bg-white dark:bg-[#1a1a1a] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 text-center">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <AnimateOnScroll key={index} delay={index * 100}>
                <div className="group relative bg-white dark:bg-[#1a1a1a] rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 border border-neutral-100 dark:border-neutral-800 hover:border-transparent h-full flex flex-col">
                  {/* Gradient Header */}
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    {/* Credential ID */}
                    <div className="bg-neutral-50 dark:bg-neutral-900 rounded-lg px-3 py-2 mb-4 flex-1">
