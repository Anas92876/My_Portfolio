          ...
          <div className="space-y-8">
            {experiences.map((exp, index) => (
              <AnimateOnScroll key={index} delay={index * 100}>
                <div className="relative pl-8 md:pl-12 border-l-2 border-primary-300 dark:border-primary-800">
                  {/* Timeline dot */}
                  <div className="absolute -left-2 top-0 w-4 h-4 bg-primary-600 dark:bg-primary-400 rounded-full"></div>

                  <div className="bg-white dark:bg-[#1a1a1a] border border-transparent dark:border-neutral-800 p-6 rounded-xl shadow-md dark:shadow-primary-500/10 hover:shadow-lg dark:hover:shadow-primary-500/20 transition-shadow duration-300">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {achievements.map((achievement, index) => (
              <AnimateOnScroll key={index} delay={index * 100}>
                <div className="bg-white dark:bg-[#1a1a1a] border border-transparent dark:border-neutral-800 p-6 rounded-xl shadow-md dark:shadow-primary-500/10 hover:shadow-lg dark:hover:shadow-primary-500/20 transition-all duration-300 text-center">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <AnimateOnScroll key={index} delay={index * 100}>
                <div className="group relative bg-white dark:bg-[#1a1a1a] rounded-2xl overflow-hidden shadow-md dark:shadow-primary-500/10 hover:shadow-2xl dark:hover:shadow-primary-500/20 transition-all duration-500 border border-neutral-100 dark:border-neutral-800 hover:border-transparent h-full flex flex-col">
                  {/* Gradient Header */}
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    {/* Credential ID */}
                    <div className="bg-neutral-50 dark:bg-neutral-900 border border-transparent dark:border-neutral-800 rounded-lg px-3 py-2 mb-4 flex-1">
                  ...
                  {/* Verified Badge */}
                  <div className="absolute top-4 right-4 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 border border-transparent dark:border-green-800 px-2 py-1 rounded-full text-xs font-medium flex items-center gap-1">
