      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {skillCategories.map((category, index) => (
          <AnimateOnScroll key={category.title} delay={index * 100}>
            <div className="bg-white dark:bg-[#1a1a1a] p-6 rounded-xl shadow-md dark:shadow-primary-500/10 border border-transparent dark:border-neutral-800 hover:shadow-lg dark:hover:shadow-primary-500/20 transition-all duration-300 h-full flex flex-col">
              <h3 className="text-xl font-bold text-neutral-900 dark:text-neutral-50 mb-4 pb-3 border-b-2 border-primary-200 dark:border-primary-800">
                {category.title}
              </h3>
