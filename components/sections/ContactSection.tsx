      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                {contactInfo.map((info) => (
                  <a
                    ...
                    className="flex items-center gap-4 p-4 bg-white dark:bg-[#1a1a1a] rounded-lg hover:shadow-md transition-shadow duration-200 group"
                  >
          ...
          <AnimateOnScroll delay={200}>
            <div className="bg-white dark:bg-[#1a1a1a] p-8 rounded-xl shadow-md">
              <h3 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-6">
                Send a Message
              </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-neutral-300 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    className="w-full px-4 py-3 border border-neutral-300 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all resize-none"
